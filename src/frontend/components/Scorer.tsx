...
function SpecialConditions({ win, onChangeWin }: { win: WinState; onChangeWin: (fn: (w: WinState) => WinState) => void }) {
  const specialLabels = { fromFlowerWall: 'Flower Wall draw', lastTile: 'Last tile', firstTurn: 'Won on your 1st turn', prodigy: 'Ready in 4', twoKongMahjong: '2 Kong Mahjong' } as const;
