...
export const rules: Rule[] = [
  ...
  { name: 'littleAndBigChow', label: 'Little and Big Chow', pts: '1 ea.', score: littleAndBigChow },
  { name: 'littleAndBigPong', label: 'Little and Big Pong', pts: '1 ea.', score: littleAndBigPong },
  ...
  { name: 'pure19sPongs', label: "Pure 1's or 9's Pongs", pts: '16', score: pure19sPongs, absorbs: ['semiMixed19s', 'pureMixed19s', 'semi19sPongs', 'littleAndBigPong', 'allPongs'] },
  ...
  { name: 'heavenlyHand', label: 'Heavenly Hand', pts: '24', score: heavenlyHand, absorbs: ['selfPick', 'cleanDoorstep', 'cleanDoorstepAndSelfPick', 'prodigyHand'] },
  { name: 'earthlyHand', label: 'Earthly Hand', pts: '16', score: earthlyHand, absorbs: ['cleanDoorstep', 'prodigyHand'] },
  { name: 'heavenlyGates', label: 'Heavenly Gates', pts: '16', score: heavenlyGates, absorbs: ['pure', 'cleanDoorstep', 'cleanDoorstepAndSelfPick', 'canOnlyWinWithOne', 'pairOf258', 'oneToNineTrain', 'littleAndBigChow', 'littleAndBigPong'] },
