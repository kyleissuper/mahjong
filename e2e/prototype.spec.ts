...
const HANDS: HandDef[] = [
  ...
  {
    name: 'Hand 2: all chows, self-pick (8 pts)',
  ...
  {
    name: 'Hand 4: all greens, all pongs (20 pts)',
  ...
  {
    name: 'Hand 10: pure, four hidden pongs (27 pts)',
